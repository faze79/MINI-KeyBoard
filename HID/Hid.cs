...
public class Hid
{
  ...
  private const int MAX_USB_DEVICES = 64 /*0x40*/;
    ...
    ref List<string> serialList)
  {
    ...
    {
      IntPtr file = Hid.CreateFile(deviceList[index], 3221225472U /*0xC0000000*/, 0U, 0U, 3U, 1073741824U /*0x40000000*/, 0U);
      if (file != Hid.INVALID_HANDLE_VALUE)
      {
        IntPtr num = Marshal.AllocHGlobal(512 /*0x0200*/);
        HIDD_ATTRIBUTES attributes;
        Hid.HidD_GetAttributes(file, out attributes);
        Hid.HidD_GetSerialNumberString(file, num, 512 /*0x0200*/);
  ...
  public static void GetHidDeviceList(ref List<string> deviceList)
  {
    ...
    if (classDevs != IntPtr.Zero)
    {
      ...
      for (uint memberIndex = 0; memberIndex < 64U /*0x40*/; ++memberIndex)
      {
  ...
  {
    [FieldOffset(0)]
    public int dbch_size = Marshal.SizeOf(typeof (Hid.DevBroadcastDeviceInterfaceBuffer));
    [FieldOffset(4)]
