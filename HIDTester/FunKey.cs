...
public class FunKey : UserControl
{
  ...
  {
    FormMain.KeyParam.Data_Send_Buff[(int) FormMain.KeyParam.KEY_Char_Num - 1] |= (byte) 16 /*0x10*/;
    FormMain.KeyParam.FunKeyChar[(int) FormMain.KeyParam.FunKEY_Char_Num] = "Ctrl";
    this.FunGeneral_Char_Set();
  }
  ...
  {
    FormMain.KeyParam.Data_Send_Buff[(int) FormMain.KeyParam.KEY_Char_Num - 1] |= (byte) 32 /*0x20*/;
    FormMain.KeyParam.FunKeyChar[(int) FormMain.KeyParam.FunKEY_Char_Num] = "Shift";
    this.FunGeneral_Char_Set();
  }
  ...
  {
    FormMain.KeyParam.Data_Send_Buff[(int) FormMain.KeyParam.KEY_Char_Num - 1] |= (byte) 64 /*0x40*/;
    FormMain.KeyParam.FunKeyChar[(int) FormMain.KeyParam.FunKEY_Char_Num] = "Alt";
    this.FunGeneral_Char_Set();
  }
  ...
  {
    FormMain.KeyParam.Data_Send_Buff[(int) FormMain.KeyParam.KEY_Char_Num - 1] |= (byte) 128 /*0x80*/;
    FormMain.KeyParam.FunKeyChar[(int) FormMain.KeyParam.FunKEY_Char_Num] = "Win";
    this.FunGeneral_Char_Set();
  }
  ...
  {
    this.ShiftGeneral_Char_Set();
    FormMain.KeyParam.Data_Send_Buff[(int) FormMain.KeyParam.KEY_Char_Num] = (byte) 31 /*0x1F*/;
  ...
  {
    this.ShiftGeneral_Char_Set();
    FormMain.KeyParam.Data_Send_Buff[(int) FormMain.KeyParam.KEY_Char_Num] = (byte) 32 /*0x20*/;
  ...
  {
    this.ShiftGeneral_Char_Set();
    FormMain.KeyParam.Data_Send_Buff[(int) FormMain.KeyParam.KEY_Char_Num] = (byte) 48 /*0x30*/;
  ...
  private void InitializeComponent()
  {
    ...
    this.KEY_ALT_Right.Location = new Point(103, 32 /*0x20*/);
    ...
    this.KEY_Shift_right.Location = new Point(206, 32 /*0x20*/);
    ...
    this.KEY_Ctrl_Right.Location = new Point(3, 32 /*0x20*/);
    ...
    this.KEY_Win_Right.Location = new Point(309, 32 /*0x20*/);
    ...
    this.KEY_Ctrl_Shift_Alt.TabIndex = 80 /*0x50*/;
    ...
    this.KEY_Shift_And_6.Location = new Point(423, 32 /*0x20*/);
    ...
    this.KEY_Shift_And_7.Location = new Point(470, 32 /*0x20*/);
    ...
    this.KEY_Shift_And_8.Location = new Point(517, 32 /*0x20*/);
    ...
    this.KEY_Shift_And_9.Location = new Point(564, 32 /*0x20*/);
    ...
    this.KEY_Shift_And_10.Location = new Point(611, 32 /*0x20*/);
    ...
    this.KEY_Shift_And_13.TabIndex = 96 /*0x60*/;
