...
public class BasicKeys : UserControl
{
  ...
  {
    FormMain.KeyParam.Data_Send_Buff[(int) FormMain.KeyParam.KEY_Char_Num] = (byte) 16 /*0x10*/;
  ...
  {
    FormMain.KeyParam.Data_Send_Buff[(int) FormMain.KeyParam.KEY_Char_Num] = (byte) 63 /*0x3F*/;
  ...
  {
    FormMain.KeyParam.Data_Send_Buff[(int) FormMain.KeyParam.KEY_Char_Num] = (byte) 80 /*0x50*/;
    FormMain.KeyParam.KeyChar[(int) FormMain.KeyParam.KEY_Char_Num - 5] = "?";
    this.General_Char_Set();
  }
  ...
  {
    FormMain.KeyParam.Data_Send_Buff[(int) FormMain.KeyParam.KEY_Char_Num] = (byte) 96 /*0x60*/;
    FormMain.KeyParam.KeyChar[(int) FormMain.KeyParam.KEY_Char_Num - 5] = "8";
    this.General_Char_Set();
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.KEY_0.Location = new Point(512 /*0x0200*/, 65);
    ...
    this.KEY_DEL.Size = new Size(63 /*0x3F*/, 23);
    ...
    this.KEY_kuohao.TabIndex = 63 /*0x3F*/;
    ...
    this.KEY_kuohao2.TabIndex = 64 /*0x40*/;
    ...
    this.KEY_Menu.Font = new Font("??", 14.25f, FontStyle.Regular, GraphicsUnit.Point, (byte) 134);
    this.KEY_Menu.Location = new Point(668, 123);
    this.KEY_Menu.Name = "KEY_Menu";
    this.KEY_Menu.Size = new Size(44, 23);
    this.KEY_Menu.TabIndex = 96 /*0x60*/;
    this.KEY_Menu.Text = "?";
    ...
    this.Key_Shift.Size = new Size(64 /*0x40*/, 23);
