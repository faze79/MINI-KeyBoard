...
internal static class NativeMethods
{
  ...
  internal const uint WAIT_FAILED = 4294967295 /*0xFFFFFFFF*/;
  ...
  internal const short DIGCF_DEVICEINTERFACE = 16 /*0x10*/;
  ...
  internal const int SPDRP_REMOVAL_POLICY = 31 /*0x1F*/;
  internal const int SPDRP_REMOVAL_POLICY_HW_DEFAULT = 32 /*0x20*/;
  ...
  internal const int SPDRP_UI_NUMBER = 16 /*0x10*/;
  internal const int SPDRP_UI_NUMBER_DESC_FORMAT = 29;
  internal const int SPDRP_UPPERFILTERS = 17;
  internal static NativeMethods.DEVPROPKEY DEVPKEY_Device_BusReportedDeviceDesc = new NativeMethods.DEVPROPKEY()
  {
    fmtid = new Guid(1410045054U, (ushort) 35648, (ushort) 17852, (byte) 168, (byte) 162, (byte) 106, (byte) 11, (byte) 137, (byte) 76, (byte) 189, (byte) 162),
    pid = 4
  };
  ...
  internal static extern IntPtr CreateEvent(
    ref NativeMethods.SECURITY_ATTRIBUTES securityAttributes,
    int bManualReset,
    int bInitialState,
    string lpName);
  ...
  public static extern bool SetupDiGetDeviceProperty(
    IntPtr deviceInfo,
    ref NativeMethods.SP_DEVINFO_DATA deviceInfoData,
    ref NativeMethods.DEVPROPKEY propkey,
  ...
  [DllImport("setupapi.dll", EntryPoint = "SetupDiGetDeviceInterfaceDetail", CharSet = CharSet.Auto)]
